...
def print_stats(divider=5000):
    ...
    for name in all_fn_names:
        print(format_str.format(name, _total_times[name] * 1000 / divider))    # val2017, 5k ims.

    print(sep_text)
    print(format_str.format('Total', total_time() * 1000 / divider))    # val2017, 5k ims.
    print()
