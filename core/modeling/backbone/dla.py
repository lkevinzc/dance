...
def dla34(cfg, pretrained=None, **kwargs):  # DLA-34
    model = DLA(
        cfg, [1, 1, 1, 2, 2, 1], [16, 32, 64, 128, 256, 512], block=BasicBlock, **kwargs
    )
...
def dla46_c(cfg, pretrained=None, **kwargs):  # DLA-46-C
    ...
    model = DLA(
        cfg, [1, 1, 1, 2, 2, 1], [16, 32, 64, 64, 128, 256], block=Bottleneck, **kwargs
    )
    if pretrained is not None:
...
def dla46x_c(cfg, pretrained=None, **kwargs):  # DLA-X-46-C
    ...
    model = DLA(
        cfg, [1, 1, 1, 2, 2, 1], [16, 32, 64, 64, 128, 256], block=BottleneckX, **kwargs
    )
    if pretrained is not None:
...
def dla60x_c(cfg, pretrained=None, **kwargs):  # DLA-X-60-C
    BottleneckX.expansion = 2
    model = DLA(
        cfg, [1, 1, 1, 2, 3, 1], [16, 32, 64, 64, 128, 256], block=BottleneckX, **kwargs
    )
    if pretrained is not None:
