"""
Codes adapted from FCOS (https://github.com/aim-uofa/AdelaiDet/blob/master/adet/modeling/fcos/fcos.py)
"""
import math
from typing import Dict, List

import torch
from core.layers import DFConv2d, EXTLoss, IOULoss
...
class FCOSE(nn.Module):
    ...
    def forward(self, images, features, gt_instances):
        ...
        logits_pred, reg_pred, ex_pred, ctrness_pred, bbox_towers = self.fcose_head(
            features
        )
...
class FCOSEHead(nn.Module):
    def __init__(self, cfg, input_shape: List[ShapeSpec]):
        ...
        self.extrm_pred = nn.Conv2d(in_channels, 4, kernel_size=3, stride=1, padding=1)
